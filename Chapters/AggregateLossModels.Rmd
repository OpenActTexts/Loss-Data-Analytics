...
**Example `r chapnum`.2.1. Course 3, May 2000, 19.**
...
**Example `r chapnum`.2.3. Course 3, May 2000, 19 (Follow-Up).**
...
**Example `r chapnum`.2.6. SOA Sample Question, 283 (modified).**
...
**Example `r chapnum`.3.1. Course 3, May 2001, 36.**
...
**Example `r chapnum`.3.2. Course 3, May 2001, 29.**
...
**Example `r chapnum`.3.3. Course 3, Fall 2002, 36.**
...
**Example `r chapnum`.3.4. Exam 3, May 2000, 16.**
You are given:
...
**Example `r chapnum`.3.5. Course 3, November 2000, 32.**
...
**Example `r chapnum`.3.6. Exam M, Fall 2005, 19.**
...
**Example `r chapnum`.4.1. SOA Fall 2002, 36.**
...
**Example `r chapnum`.5.5. Course 3, November 2001, 6.**
...
**Example `r chapnum`.5.7. SOA Sample Question, 109.**
