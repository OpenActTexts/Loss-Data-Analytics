...
`r HideExample('3.1.1','Show Example Solution')`
...
`r HideExample('3.1.2','Show Example Solution')`
...
`r HideExample('3.1.3','Show Example Solution')`
...
`r HideExample('3.1.4','Show Example Solution')`
...
`r HideExample('3.2.1','Show Example Solution')`
...
`r HideExample('3.2.2','Show Example Solution')`
...
`r HideExample('3.3.2','Show Example Solution')`
...
`r HideExample('3.3.3','Show Example Solution')`
...
Simulation, discussed in Chapter \@ref(C:Simulation), provides a direct application of this result. Suppose we know how to simulate an outcome with an $F-distribution$ (that is easy to do using, for example, the `R` function `rf(n,df1,df2)`), say $F$. Then we raise it to the power $\sigma$ and multiply it by $\theta$ so that $\theta ~ F^{\sigma}$ is an outcome that has a *GB2* distribution.

Residual analysis provides another direct application. Suppose we have an outcome, say $X$, that we think comes from a *GB2* distribution. Then we can examine the transformed version $X^{\ast} = \left(X/\theta\right)^{1/\sigma}$. If the original specification is correct, then $X^{\ast}$ has an $F-$ distribution and there are many well-known techniques, some described in Chapter \@ref(C:ModelSelection), for verifying this assertion.
...
`r HideExample('3.3.4','Show Example Solution')`
...
`r HideExample('3.3.5','Show Example Solution')`
...
`r HideExample('3.3.6','Show Example Solution')`
...
`r HideExample('3.3.7','Show Example Solution')`
...
`r HideExample('3.3.8','Show Example Solution')`
...
`r HideExample('3.4.1','Show Example Solution')`
...
`r HideExample('3.4.2','Show Example Solution')`
...
`r HideExample('3.4.3','Show Example Solution')`
...
`r HideExample('3.4.4','Show Example Solution')`
...
`r HideExample('3.4.5','Show Example Solution')`
...
`r HideExample('3.4.6','Show Example Solution')`
...
Appendix Section \@ref(S:AppA:MLE) reviews the foundations of maximum likelihood estimation with more mathematical details in Appendix Chapter \@ref(C:AppC).

**Example `r chapnum`.5.1. Actuarial Exam Question.** You are given the following five observations: 521, 658, 702, 819, 1217. You use the single-parameter Pareto with distribution function:
...
`r HideExample('3.5.2','Show Example Solution')`
...
`r HideExample('3.5.3','Show Example Solution')`
...
`r HideExample('3.5.2a','Show Example Solution')`
...
`r HideExample('3.5.3a','Show Example Solution')`
...
`r HideExample('3.5.4','Show Example Solution')`
...
`r HideExample('3.5.5','Show Example Solution')`
...
`r HideExample('3.5.6','Show Example Solution')`
...
`r HideExample('3.5.7','Show Example Solution')`
