...
Pearson's chi-square statistic above. For example, the R code below does
calculate an estimate for \(\lambda\) doing the latter and results in
the estimate \(0.06623153\), close but different from the \emph{mle} of
\(\lambda\) using the full data:
...
\textbf{Example 5.2.1. Course 3, May 2000, 19.} An insurance company
...
\textbf{Example 5.2.3. Course 3, May 2000, 19 (Follow-Up).} As in the
...
\textbf{Example 5.2.6. SOA Sample Question, 283 (modified).} The annual
...
\textbf{Example 5.3.1. Course 3, May 2001, 36.} The number of accidents
...
\textbf{Example 5.3.2. Course 3, May 2001, 29.} You are the producer of
...
\textbf{Example 5.3.3. Course 3, Fall 2002, 36.} The number of claims in
a period has a geometric distribution with mean \(4\). The amount of
each claim \(X\) follows \(\Pr(X=x) = 0.25, \ x=1,2,3,4.\) The number of
...
\textbf{Example 5.3.4. Exam 3, May 2000, 16.} You are given:
...
\textbf{Example 5.3.5. Course 3, November 2000, 32.} For an individual
over \(65\):\\
...
\textbf{Example 5.3.6. Exam M, Fall 2005, 19.} In a given week, the
...
\textbf{Example 5.4.1. SOA Fall 2002, 36.} The number of claims in a
...
\textbf{Example 5.5.5. Course 3, November 2001, 6.} A group dental
policy has a negative binomial claim count distribution with mean 300
and variance 800. Ground-up severity is given by the following table:
...
\textbf{Example 5.5.7. SOA Sample Question, 109.} A company insures a
