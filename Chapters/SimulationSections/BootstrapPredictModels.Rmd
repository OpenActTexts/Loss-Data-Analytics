...
With `r Gloss('GLM')`s it is natural to use the second type of algorithm, where residuals are resampled. Because a strong assumption is to have i.id. sample, we will usually use Pearson's residuals. For instance, with a Poisson regression
$$
