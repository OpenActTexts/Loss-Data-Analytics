...
<img src = "ContributorPics\zeinab_amin_photo.jpg" width = "150" height = "200" style = "float:right; margin-left: 10px; margin-top: 7px" />
...
<img src = "ContributorPics\Okine_A.jpg" width = "150" height = "130" style = "float:right; margin-left: 10px; margin-top: 7px" />
...
<img src = "ContributorPics\Selin_pictureA.png" width = "150" height = "130" style = "float:right; margin-left: 10px; margin-top: 7px" />
...
The project goal is to have the actuarial community author our textbooks in a collaborative fashion. Part of the writing process involves many reviewers who generously donated their time to help make this book better. They are:
