...
Chapter four includes a section on Bayesian inference and it is assumed that the reader is familiar with that material.  This section will compare Bayesian inference and B&uuml;hlmann credibility and show connections between the two models.
...
- **Gary Dean**, Ball State University is the author of the initital version of this chapter. Email: <cgdean@bsu.edu> for chapter comments and suggested improvements.
