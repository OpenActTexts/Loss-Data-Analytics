...
<ul>
<li>a. The shape and scale parameters.</li>
<li>b. The 95-th percentile of this distribution.</li>
</ul>
...
<ul>
<li>a. Find the probability that a randomly selected person from this population survives at least 12 months,</li>
<li>b. A random sample of 10 patients will be selected from this population. What is the probability that at most two will die within
    one year of diagnosis.</li>
<li>c. Find the 99-th percentile of this distribution.</li>
</ul>
...
<ul><li>a. Calculate the maximum likelihood estimator for $\theta$.</li>
<li>b. Approximate the variance of the maximum likelihood estimator.</li>
<li> c. Determine an approximate 95% confidence interval for $\theta$.</li>
<li>d. Determine an approximate 95% confidence interval for $\Pr \left( X \leq 9,000 \right).$</li>
</ul>
...
<ul>
<li>a. Calculate the maximum likelihood estimator for $\mu$ and $\sigma$.</li>
<li>b. Estimate the covariance matrix of the maximum likelihood estimator.</li>
<li>c. Determine approximate 95% confidence intervals for $\mu$ and $\sigma$.</li>
<li>d. Determine an approximate 95% confidence interval for the mean of the lognormal distribution.</li>
</ul>
