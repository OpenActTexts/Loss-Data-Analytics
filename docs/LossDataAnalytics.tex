...
\includegraphics[width=0.20000\textwidth]{ContributorPics/zeinab_amin_photo.jpg}
...
\includegraphics[width=0.20000\textwidth]{ContributorPics/PhotoGaryDean.jpg}
...
\item
  ...
  the American Statistical Association. He has published extensively and
  is a four-time winner of the Halmstad and Prize for best paper
  published in the actuarial literature. He has written three books and
  is a co-editor of the two-volume series \emph{Predictive Modeling
  Applications in Actuarial Science} published by Cambridge University
  Press.
\end{itemize}

\includegraphics[width=0.20000\textwidth]{ContributorPics/Frees_Jed2018_150x188.jpg}
...
\includegraphics[width=0.20000\textwidth]{ContributorPics/GuojunGan.jpg}
...
\item
  ...
  currently has about 180 publications, consisting of 88 journal
  articles and 95 proceedings.
\end{itemize}

\includegraphics[width=0.20000\textwidth]{ContributorPics/Noriszura.jpg}
...
\includegraphics[width=0.20000\textwidth]{ContributorPics/JosephKimPic.jpg}
...
\includegraphics[width=0.20000\textwidth]{ContributorPics/Okine_A.jpg}
...
\item
  ...
  department of Mimar Sinan University, Istanbul, Turkey. She holds a
  bachelor degree in Actuarial Science with a minor in Economics and a
  master degree in Actuarial Science from Hacettepe University. Her
  research interest includes dependence modeling, regression, loss
  models and life contingencies.
\end{itemize}

\includegraphics[width=0.20000\textwidth]{ContributorPics/Selin_pictureA.png}
...
\includegraphics[width=0.20000\textwidth]{ContributorPics/krupaviswanathan2.jpg}
...
be seen by clicking on terms such as \emph{R Code for Frequency Table}.
...
encourage you to try the some statistical code as you read the book --
we have opted to make it easy to learn \texttt{R} as you go. We have
even set up a separate \href{https://openacttexts.github.io/LDARcode}{R
Code for Loss Data Analytics} site to explain more of the details of the
code.
...
although not particulary entertaining, insurance plays an important role
in the economies of nation and the lives of individuals.
...
the like. We call these obligations \emph{insurance claims}. With this
focus, we will be able to introduce generally applicable statistical
...
\item
  ...
  reserves, an estimate of the insurer's future liability. This is an
  important input to the insurer's loss reserves, described in Section
  \ref{S:Reserving}.
\end{itemize}
...
as \emph{valuation dates.} Claims that arise prior to valuation dates
have typically been or are about to paid; claims in the future of these
valuation dates are unknown. A company must estimate these outstanding
liabilities when determining its financial strength. Accurately
...
insured event. \emph{Indemnification} is the compensation provided by
...
the \emph{pure premium} or \emph{loss cost}.
