...
<h4 style="text-align: left;"><a id="SOL:S2b:MLE:display" href="javascript:toggle('SOL:S2b:MLE','SOL:S2b:MLE:display');"><i><strong>Show Solution</strong></i></a></h4>
...
<h4 style="text-align: left;"><a id="SOL:S2b:COV:display" href="javascript:toggle('SOL:S2b:COV','SOL:S2b:COV:display');"><i><strong>Show Solution</strong></i></a></h4>
