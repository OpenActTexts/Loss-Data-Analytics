...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include_url}\NormalTok{(}\StringTok{"http://www.ssc.wisc.edu/~jfrees/loss-data-analytics/loss-data-analytics-problems/"}\NormalTok{,}\DataTypeTok{height =} \StringTok{"200px"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.4\linewidth]{LossDataAnalytics_files/figure-latex/unnamed-chunk-4-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include_url}\NormalTok{(}\StringTok{"http://www.ssc.wisc.edu/~jfrees/loss-data-analytics/loss-data-analytics-model-selection/"}\NormalTok{,}\DataTypeTok{height =} \StringTok{"200px"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\section*{Technical Supplement - Gini
Statistic}\label{technical-supplement---gini-statistic}
\addcontentsline{toc}{section}{Technical Supplement - Gini Statistic}

\subsection{The Classic Lorenz Curve}\label{the-classic-lorenz-curve}
...
\subsection{Ordered Lorenz Curve and the Gini
...
\subsection{Out-of-Sample Validation}\label{out-of-sample-validation-1}
...
{\centering \includegraphics[width=0.5\linewidth]{LossDataAnalytics_files/figure-latex/unnamed-chunk-8-1} 
...
\begin{center}\includegraphics{LossDataAnalytics_files/figure-latex/unnamed-chunk-38-1} \end{center}
