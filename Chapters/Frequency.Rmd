...
Table `r chapnum`.2: Calculation of probabilities for $k\leq 3$ 
...
**Example  `r chapnum`.6.1. "Exam C" 170**.
...
Table `r chapnum`.3: The distribution of the population and the mean number of colds
...
Table `r chapnum`.4: Singaporean Automobile Accident Data
...
- **N.D. Shyamalkumar**, The University of Iowa, is the principal author of the initital version of this chapter. Email: shyamal-kumar@uiowa.edu for chapter comments and suggested improvements.
- **Krupa Viswanathan**, Temple University, <ksubrama@temple.edu>, provided substantial improvements.
