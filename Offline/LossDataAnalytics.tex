...
generalized to multivariate settings. Section 15.4.4 provides a summary
of these statistics.
...
4.1.2.2, are useful for model comparison. For discrete data, a
\emph{chi-square goodness of fit statistic} (see Section 2.7) is
