...
insurance data. Section \@ref(sec:Intro) begins with a discussion of why the use of
...
book. Next, Section \@ref(sec:PredModApps) gives a general overview
of the purposes of analyzing insurance data which is reinforced in the
Section \@ref(sec:LGPIF) case study. Naturally, there is a huge gap between these broads goals and a case study application; this gap
is covered through the methods and techniques of data analysis covered
in the rest of the text.


## Relevance of Analytics {#sec:Intro}
...
### Insurance Processes {#sec:InsProcesses}
...
described in Section \@ref(sec:PredModApps); these are marked with an **x** on
...
## Case Study: Wisconsin Property Fund {#sec:LGPIF}
...
### Fund Claims Variables {#sec:OutComes}
...
### Fund Rating Variables {#sec:FundVariables}
...
functional areas are described in Section \@ref(sec:PredModApps); let us now
