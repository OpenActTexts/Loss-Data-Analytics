...
**Example `r chapnum`.1.5. Exam C Question 3.** 
...
**Example `r chapnum`.1.6. Exam C Question 59.** 
...
**Exaxmple  `r chapnum`.1.7. Exam C Question 40 (modified).**
...
**Exercise `r chapnum`.1.10. Exam C Question 1.** 
You are given: 
...
## Model Selection {#S:ModelSelection}
...
### Summarizing Model Selection Based on a Training Dataset
...
**Likelihood Ratio Tests.** For comparing model fits, if one model is a subset of another, then a likelihood ratio test may be employed. 

**Goodness of Fit Statistics.**

Generally, models are not proper subsets of one another so overall goodness of fit statistics, summarized in Section \@ref{S:NonparametricModelSelection}, are useful for model comparison. For discrete data, a **chi-square goodness of fit statistic** is generally preferred as it is more intuitive and simpler to explain.
...
## Estimation using Modified Data {#S:ModifiedData}
...
**Example `r chapnum`.3.1. Exam C Question 44.** 
You are given:
...
**Example `r chapnum`.3.2. Exam C Question 152.**
You are given:
...
**Example `r chapnum`.3.3. Course 4: Fall 2000, Question 22.**
...
**Example `r chapnum`.3.4. Exam C Question 195.** You are given the following information regarding claim sizes for 100 claims:
...
**Example `r chapnum`.3.5. Exam C Question 252.**
...
**Example `r chapnum`.3.6. Exam C Question 135.** 
...
**Exercise `r chapnum`.3.7. Exam C Question 252. - Continued.** 
...
**Exercise `r chapnum`.4.1. Exam C Question 157.** 
You are given: 
...
**Example `r chapnum`.4.2. Exam C Question 43.**
You are given:
...
**Example `r chapnum`.4.3. Exam C Question 190.** 
...
**Example `r chapnum`.4.4. Exam C Question 11.** 
You are given:
...
**Exercise `r chapnum`.4.5. Exam C Question 15.** 
You are given:
...
**Example `r chapnum`.4.6. Exam C Question 29.** 
You are given:
...
**Example `r chapnum`.4.7. Exam C Question 215.** 
You are given:
...
- **Edward W. (Jed) Frees** and **Lisa Gao**, University of Wisconsin-Madison, are the principal authors of the initital version of this chapter. Email: jfrees@bus.wisc.edu for chapter comments and suggested improvements.
