...
Draw a value $x_{t+1}^\star$, and $u$, from a uniform distribution. Compute 
$$
\displaystyle{R=\frac{xx}{xx}} 
$$
and 
...
```{r sampleani_HM_1, animation.hook='gifski'}
...
```{r sampleani_HM, animation.hook='gifski'}
