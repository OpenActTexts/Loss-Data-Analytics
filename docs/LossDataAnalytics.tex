...
is known as the \textbf{nonparametric} approach.
...
\textbf{left-truncated} at \(C_L\) when the amount is \[\begin{aligned}
Y &=
\left\{
\begin{array}{ll}
...
the survival function conditional on survival to time 5,
