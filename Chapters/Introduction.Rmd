...
features, such as the choice of a `r Gloss('deductible')` or the amount of coverage.
...
modify contract payouts. Chapters \@ref(C:Severity) and \@ref(C:PortMgt) describe common modifications including `r Gloss('coinsurance')`, deductibles and `r Gloss('policy upper limits')`.
